describe("Is", function () {
    ...
    it("should trigger 'then' if  all are true", function () {
        var count = 0;
        Is("foo").matching("foo").then(function () {
            count = 1;
        });
        expect(count).toBe(1);
    });
    it("should not trigger 'then' if  not all are true", function () {
        var count = 0;
        Is("foo").matching("foo", "bar").then(function () {
            count = 1;
        });
        expect(count).toBe(0);
    });
    it("should not trigger 'then' if  not all are true", function () {
        var count = 0;
        Is("foo").matching("foo", "length<3").then(function () {
            count = 1;
        });
        expect(count).toBe(0);
    });
    it("should trigger 'then' if  any are true", function () {
        var count = 0;
        Is("foo").matchingAny("foo", "bar").then(function () {
            count = 1;
        });
        expect(count).toBe(1);
    });
    it("should trigger 'then' if  any are true for equalTo", function () {
        var count = 0;
        Is("foo").matchingAny("foo").then(function () {
            count = 1;
        });
        expect(count).toBe(1);
    });
    it("should trigger 'then' if  any are not true for equalTo", function () {
        var count = 0;
        Is("foo").matchingAny("foo2").then(function () {
            count = 1;
        });
        expect(count).toBe(0);
    });
    ...
    it("should trigger then if any shorthand length checks are true", function () {
        var count = 0;
        Is(1).matchingAny("<4)", ">10").then(function () {
            count = 1;
        });
        expect(count).toBe(1);
    });
    ...
    it("should return false if an array is empty and inverse is true", function () {
        var count;
        Is([]).not.emptyArray().then(function () {
            count = 1;
        }).catch(function () {
            count = 0;
        });
    ...
    it("should return false if an array is not empty", function () {
        var count;
        Is([1, 2, 3]).emptyArray().then(function () {
            count = 1;
        }).catch(function () {
            count = 0;
        });
    ...
    it("should return true if an array is not empty and inverse is true", function () {
        var count;
        Is([1, 2, 3]).not.emptyArray().then(function () {
            count = 1;
        }).catch(function () {
            count = 0;
        });
    ...
    it("should allow you to check a param of an object", function () {
        var count;
        Is({ foo: "bar", bar: "baz" }).prop("foo").equalTo("bar").prop("bar").longerThan(2).then(function () {
            count = 1;
        }).catch(function () {
            count = 0;
        });
    ...
    it("should allow you to check a param of an object if inverse is false", function () {
        var count;
        Is({ foo: "bar" }).prop("foo").not.equalTo("bar2").then(function () {
            count = 1;
        }).catch(function () {
            count = 0;
        });
    ...
    it("should return false if none of the or validations are true for objects", function () {
        var count = 0;
        Is({ foo: 3, bar: "baz" }).prop("foo").greaterThan(15).or.prop("foo").lessThan(2).or.prop("bar").shorterThan(3).or.prop("bar").longerThan(3).then(function () {
            count = 1;
        });
        expect(count).toBe(0);
    });
    it("should return true if any of the or validations are true for matchers", function () {
        var count = 0;
        Is({ foo: 3, bar: "baz" }).prop("foo").matchingAny(">4", "<2").or.prop("bar").matchingAny("length>2").then(function () {
            count = 1;
        });
        expect(count).toBe(1);
    });
    it("should return false if none of the or validations are true for matchers", function () {
        var count = 0;
        Is({ foo: 3, bar: "baz" }).prop("foo").matchingAny(">4", "<2").or.prop("bar").matchingAny("length>4").then(function () {
            count = 1;
        });
        expect(count).toBe(0);
    });
